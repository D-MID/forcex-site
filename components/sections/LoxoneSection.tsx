...
export function LoxoneSection() {
  return (
    <section className="relative section overflow-hidden" style={{ backgroundColor: '#08080A' }}>
      {/* Background grid */}
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <FadeUp>
            <h2 className="text-4xl md:text-6xl font-black text-white leading-none mb-6">
              Your Building,{' '}
              <span style={{ color: '#DC2626' }}>Fully Alive.</span>
            </h2>
            ...
            <p className="text-base leading-relaxed mb-10" style={{ color: '#71717A' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 h-full">
              {whyLoxone.map((item, i) => (
                ...
                >
                  ...
                  <p className="text-sm" style={{ color: '#71717A' }}>{item.sub}</p>
                </motion.div>
              ))}
            </div>
          </FadeUp>
        ...
        <motion.div
          ...
          style={{ height: '1px', backgroundColor: '#1C1C22', transformOrigin: 'left', marginBottom: '4rem' }}
        />

        {/* Capabilities grid */}
        <FadeUp className="mb-8">
          <p className="text-xs font-bold uppercase tracking-[0.2em]" style={{ color: '#DC2626' }}>
          ...
          {capabilities.map((cap, i) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: '#71717A' }}>{cap.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          style={{ backgroundColor: '#0D0D10', border: '1px solid rgba(220,38,38,0.2)' }}
        >
          <div>
