      ...
      <main className="pt-16">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <FadeUp>
              <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#0EA5E9' }}>Our Work</p>
            ...
            <FadeUp delay={0.2} className="mt-12">
              <div className="flex flex-wrap gap-8">
                {stats.map((s) => (
                  <div key={s.label}>
                    <span className="block text-3xl font-black" style={{ color: '#0EA5E9', fontFamily: 'monospace' }}>{s.value}</span>
